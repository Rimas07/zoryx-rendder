...
export function Header({ onLogoClick }: Props) {
  ...
  return (
    <header className="bg-gradient-to-r from-[#622ADA] to-[#0070BB] h-[60px] px-5 flex items-center justify-between gap-4 z-[200] shrink-0 max-sm:px-3 max-sm:gap-2">
      ...
      {/* Center — Show on map */}
      <div className="flex items-center gap-3 text-white text-[14px] font-medium select-none max-sm:hidden">
        <span>Показать на карте</span>
        <div className="w-11 h-6 rounded-full bg-white/20 flex items-center px-1 cursor-pointer">
