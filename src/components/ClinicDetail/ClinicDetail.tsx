    ...
    >
      <div
        style={{
          ...
          transform: mapOpen ? "rotateY(180deg)" : "rotateY(0deg)",
          position: "relative",
          minHeight: "100%",
        ...
        <div style={{ backfaceVisibility: "hidden", WebkitBackfaceVisibility: "hidden" } as React.CSSProperties} className="w-full p-7">
          ...
          <div className="bg-white rounded-2xl px-[18px] py-4 mb-3 shadow-[0_2px_12px_rgba(91,79,207,0.08)]">
            ...
            {clinic.specializations.length > 0 && (
              <InfoRow
                icon={
                  <Stethoscope size={20} strokeWidth={1.8} color="#5b4fcf" />
                }
              >
          ...
          <div className="bg-white rounded-2xl px-[18px] py-4 mb-3 shadow-[0_2px_12px_rgba(91,79,207,0.08)]">
            ...
            {clinic.phone && (
              <InfoRow
                icon={<Phone size={20} strokeWidth={1.8} color="#5b4fcf" />}
              >
            ...
            {clinic.email && (
              <InfoRow
                icon={<Mail size={20} strokeWidth={1.8} color="#5b4fcf" />}
              >
                <Label>{t("email")}</Label>
                <a
