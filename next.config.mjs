    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: [
            ...
            "connect-src 'self' https://firestore.googleapis.com https://firebase.googleapis.com https://identitytoolkit.googleapis.com https://api.openai.com https://api.mapy.cz https://tile.jawg.io",
